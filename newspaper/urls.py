...
from newspaper.views import index, TopicListView, NewspaperListView, NewspaperDetailView, RedactorListView, \
    RedactorDetailView, TopicDetailView, TopicCreateView, NewspaperCreateView, TopicUpdateView, TopicDeleteView, \
    NewspaperUpdateView, NewspaperDeleteView, RedactorCreateView
